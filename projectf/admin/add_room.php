	...
	<div class = "container-fluid">
		<div class = "panel panel-default">
			<div class = "panel-body">
				<div class = "alert alert-info">Room / Add Room</div>
				<br />
				<div class = "col-md-4">	
					<form method = "POST" enctype = "multipart/form-data">
						<div class="form-group">
							<label>Hotel ID</label>
							<input type = "number" min = "0" max = "999999999" class = "form-control" name = "hid" required />
						</div>
						<div class = "form-group">
						...
						<div class="form-group">
							...
							<textarea name="rdetails" cols="30" rows="10" class="form-control" required></textarea>
						</div>
						<div class = "form-group">
							<label>Price </label>
						...
						<br />
						<div class = "form-group">
							<button name = "add_room" class = "btn btn-info form-control"><i class = "glyphicon glyphicon-plus"></i> Add</button>
						</div>
					</form>
